...
public  class Calculation implements Tax {
	...
	public void pfCalculation(float ctc) {//pf calculation from 12% of salary
		pf= (float) (ctc*0.12);
	...
	public void incometaxCalculation(float ctc) {// this function calculates the income tax
		if(ctc<250000) {
			...
			incometax=(ctc-250000)*(5/100);
		}
		else if(ctc>500000 && ctc<=1000000) {
			
			incometax=12500+((ctc-500000)*20/100);
			
		}
		else {
			incometax=12500+100000+((ctc-1000000)*30/100);
		}
...
// this function calculates esi from salary.
	...
	public void empNetSalary(int ctc) {
		...
		netsalary=(int) (ctc-esi-pf-pt-incometax+rebate);
